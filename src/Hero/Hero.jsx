    ...
    return (
        <div className='flex flex-col xl:flex-row'>
            ...
            <div className='flex-col items-center justify-around  mx-3 lg:mx-24 relative mt-12'>
                <img src="public/static/images/grid.png" alt="grid-vector" className='absolute left-96 hidden xl:block' />
            ...
            <div className='w-5/6 absolute xl:w-2/6 bg-teal-800 self-center top-full xl:top-36 rounded-3xl pb-5 right-10 xl:right-48'>
                ...
                <section className=' flex flex-col items-center justify-center box-border'>
                    <img src="public/static/images/image 2.png" alt="" className=' w-11/12 my-5  rounded-lg' />
                    <section className='flex flex-col xl:flex-row items-center justify-center gap-4' >
                        <img src="public/static/images/image 2.png" alt=""  className='sw-11/12 rounded-lg'/>
                        <img src="public/static/images/image 2.png" alt="" className='w-11/12 rounded-lg' />
                    </section>
                </section>
                ...
                <img src="public/static/images/f_people.png" alt="" className='h-14 xl:h-16 absolute -right-5 -top-5'/>
                <img src="public/static/images/fo_people.png" alt=""className='h-14 xl:h-16 absolute -left-5 top-36' />
                <img src="public/static/images/s_people.png" alt=""className=' h-14 xl:h-16 absolute -right-5 bottom-24' />
                <img src="public/static/images/t_people.png" alt="" className=' h-14 xl:h-16 absolute -bottom-5 left-24'/>
            </div>
            {/* Right Section */}
