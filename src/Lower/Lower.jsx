    ...
    return (
        <div className=' flex flex-col items-center xl:items-start justify-around mx-0 xl:mx-32 my-20'>
            ...
            <div className=' flex flex-col xl:flex-row items-center justify-around my-10 w-9/12'>
                <img src="./static/images/KHM.png" alt="" className='my-10 xl:my-0' />
                <img src="./static/images/DSA.png" alt="" className='my-10 xl:my-0'/>
                <img src="./static/images/Pal.png" alt=""className='my-10 xl:my-0' />
                <img src="./static/images/Para.png" alt="" className='my-10 xl:my-0'/>
                <img src="./static/images/VD.png" alt="" className='my-10 xl:my-0'/>
            </div>
